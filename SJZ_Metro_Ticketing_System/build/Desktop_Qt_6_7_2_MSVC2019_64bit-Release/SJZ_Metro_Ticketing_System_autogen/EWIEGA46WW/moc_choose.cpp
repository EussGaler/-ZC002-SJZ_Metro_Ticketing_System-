...
Q_CONSTINIT const QMetaObject choose::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSchooseENDCLASS_t,
        ...
        // method 'do_check'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'do_send_money'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'receive_station'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void choose::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->do_returnto_railway(); break;
        case 1: _t->send_money((*reinterpret_cast< std::add_pointer_t<int&>>(_a[1]))); break;
        case 2: _t->do_return(); break;
        case 3: _t->do_double((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 4: _t->do_change((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->do_check(); break;
        case 6: _t->do_send_money(); break;
        case 7: _t->receive_station((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString&>>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &choose::do_returnto_railway; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (choose::*)(int & );
            if (_t _q_method = &choose::send_money; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void choose::send_money(int & _t1)
{
