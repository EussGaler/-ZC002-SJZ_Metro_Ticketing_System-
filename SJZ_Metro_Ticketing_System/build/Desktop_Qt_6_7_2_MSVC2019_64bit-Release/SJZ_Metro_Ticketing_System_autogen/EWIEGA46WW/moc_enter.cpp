...
constexpr auto qt_meta_stringdata_CLASSenterENDCLASS = QtMocHelpers::stringData(
    "enter",
    "do_close",
    "",
    "do_railway",
    "do_returnfrom_railway",
    "do_help"
);
...
void enter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->do_close(); break;
        case 1: _t->do_railway(); break;
        case 2: _t->do_returnfrom_railway(); break;
